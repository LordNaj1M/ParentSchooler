...
import com.example.parentschooler.databinding.ActivityGayaBelajarBinding
...
class GayaBelajarActivity : AppCompatActivity() {

    private lateinit var binding: ActivityGayaBelajarBinding
    private val soalViewModel by viewModels<KuesionerViewModel> {
        ViewModelFactory.getInstance(application)
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityGayaBelajarBinding.inflate(layoutInflater)
    ...
    private fun setButton() {
        ...
        binding.cvSoal13Opsi1.setOnClickListener{
            Soal13 = 1
            binding.cvSoal13Opsi1.setCardBackgroundColor(Color.YELLOW)
            binding.cvSoal13Opsi2.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal13Opsi3.setCardBackgroundColor(Color.WHITE)
        }
        binding.cvSoal13Opsi2.setOnClickListener{
            Soal13 = 2
            binding.cvSoal13Opsi1.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal13Opsi2.setCardBackgroundColor(Color.YELLOW)
            binding.cvSoal13Opsi3.setCardBackgroundColor(Color.WHITE)
        }
        binding.cvSoal13Opsi3.setOnClickListener{
            Soal13 = 3
            binding.cvSoal13Opsi1.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal13Opsi2.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal13Opsi3.setCardBackgroundColor(Color.YELLOW)
        }

        binding.cvSoal14Opsi1.setOnClickListener{
            Soal14 = 1
            binding.cvSoal14Opsi1.setCardBackgroundColor(Color.YELLOW)
            binding.cvSoal14Opsi2.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal14Opsi3.setCardBackgroundColor(Color.WHITE)
        }
        binding.cvSoal14Opsi2.setOnClickListener{
            Soal14 = 2
            binding.cvSoal14Opsi1.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal14Opsi2.setCardBackgroundColor(Color.YELLOW)
            binding.cvSoal14Opsi3.setCardBackgroundColor(Color.WHITE)
        }
        binding.cvSoal14Opsi3.setOnClickListener{
            Soal14 = 3
            binding.cvSoal14Opsi1.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal14Opsi2.setCardBackgroundColor(Color.WHITE)
            binding.cvSoal14Opsi3.setCardBackgroundColor(Color.YELLOW)
        }
    ...
    private fun bottomNav(){
        ...
        binding.navBottom.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                R.id.bnmHome -> {
                    val intent = Intent(this@GayaBelajarActivity, MainActivity::class.java)
                    startActivity(intent)
                    true
                }

                R.id.bnmDashboard -> {
                    val intent = Intent(this@GayaBelajarActivity, DashboardActivity::class.java)
                    startActivity(intent)
                    true
                }

                R.id.bnmChatbot -> {
                    val intent = Intent(this@GayaBelajarActivity, ChatbotActivity::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
