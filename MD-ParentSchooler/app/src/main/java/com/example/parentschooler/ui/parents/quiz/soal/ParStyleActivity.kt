...
import com.example.parentschooler.databinding.ActivityParStyleBinding
...
class ParStyleActivity : AppCompatActivity() {

    private lateinit var binding: ActivityParStyleBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityParStyleBinding.inflate(layoutInflater)
    ...
    private fun bottomNav(){
        ...
        binding.navBottom.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                R.id.bnmHome -> {
                    val intent = Intent(this@ParStyleActivity, MainActivity::class.java)
                    startActivity(intent)
                    true
                }

                R.id.bnmDashboard -> {
                    val intent = Intent(this@ParStyleActivity, DashboardActivity::class.java)
                    startActivity(intent)
                    true
                }

                R.id.bnmChatbot -> {
                    val intent = Intent(this@ParStyleActivity, ChatbotActivity::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
